...
/**
 * Created by junze on 2017-01-17.
 * Refreshable List View with index
 */

public class PullToRefreshIndexableListView extends PullToRefreshAdapterViewBase<IndexableListView> {
    ...
    public PullToRefreshIndexableListView(Context context, Mode mode, AnimationStyle animStyle) {
    ...
    protected IndexableListView createRefreshableView(Context context, AttributeSet attrs) {
        IndexableListView lv = new IndexableListView(context,attrs);
